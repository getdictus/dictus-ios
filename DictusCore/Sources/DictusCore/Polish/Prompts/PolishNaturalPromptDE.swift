...
enum PolishNaturalPromptDE {
    static func instructions() -> String {
        ...
        - Word choice: do NOT substitute synonyms. `Kumpel` stays `Kumpel` (NOT `Freund`), `Klamotten` stays (NOT `Kleidung`), `geil` stays `geil` (NOT `toll`). Placeholder words are word choice too: `Dings`, `Dingsbums`, `Dingsda` are NOT typos for `Ding`.
